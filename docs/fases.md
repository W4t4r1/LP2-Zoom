...
| **Fase 1: Sockets Multicliente** | 🟢 Completado | 100% | Servidor multihilo con `CachedThreadPool`. Cliente asíncrono con [ClienteConexion](file:///c:/Users/Jeanpier/OneDrive/Desktop/LP2-Zoom/Cliente/src/main/java/network/ClienteConexion.java) (Singleton/Observer) que evita el congelamiento de la UI. |
| **Fase 2: Registro y Login** | 🟢 Completado | 100% | Hashing SHA-256 en [HashUtils](file:///c:/Users/Jeanpier/OneDrive/Desktop/LP2-Zoom/Servidor/src/main/java/database/HashUtils.java), CRUD en [DBService](file:///c:/Users/Jeanpier/OneDrive/Desktop/LP2-Zoom/Servidor/src/main/java/database/DBService.java) y login reactivo asíncrono en [LoginFrame](file:///c:/Users/Jeanpier/OneDrive/Desktop/LP2-Zoom/Cliente/src/main/java/UI/LoginFrame.java). |
...
*   [x] Configuración limpia del archivo [.gitignore](file:///c:/Users/Jeanpier/OneDrive/Desktop/LP2-Zoom/.gitignore).
*   [x] Estructura del script DDL SQL ([schema.sql](file:///c:/Users/Jeanpier/OneDrive/Desktop/LP2-Zoom/db/schema.sql)) para Supabase.
...
*   [x] Implementación de patrón Singleton y Observer en [ClienteConexion](file:///c:/Users/Jeanpier/OneDrive/Desktop/LP2-Zoom/Cliente/src/main/java/network/ClienteConexion.java) para notificaciones asíncronas en UI.
...
*   [x] Métodos de persistencia en base de datos (`login` y `registrar`) en [DBService](file:///c:/Users/Jeanpier/OneDrive/Desktop/LP2-Zoom/Servidor/src/main/java/database/DBService.java).
*   [x] Algoritmo SHA-256 nativo implementado para hash de contraseñas.
*   [x] Formulario moderno de inicio de sesión en Swing ([LoginFrame](file:///c:/Users/Jeanpier/OneDrive/Desktop/LP2-Zoom/Cliente/src/main/java/UI/LoginFrame.java)).
*   [x] Conexión reactiva que redirige a [RoomFrame](file:///c:/Users/Jeanpier/OneDrive/Desktop/LP2-Zoom/Cliente/src/main/java/UI/RoomFrame.java) tras login exitoso.
...
*   **Frontend (100%):**
    *   [x] Habilitar el flujo en [RoomFrame](file:///c:/Users/Jeanpier/OneDrive/Desktop/LP2-Zoom/Cliente/src/main/java/UI/RoomFrame.java) para redirigir dinámicamente según la respuesta del host.
...
*   **Frontend (100%):**
    *   [x] Conectar la caja de texto `txtMensajeChat` y el botón `btnEnviarChat` de [RoomFrame](file:///c:/Users/Jeanpier/OneDrive/Desktop/LP2-Zoom/Cliente/src/main/java/UI/RoomFrame.java) para emitir el evento `CHAT_MESSAGE`.
